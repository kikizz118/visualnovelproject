...
document.querySelector(".choice8-btn").addEventListener("click", function() {
  soundLose.play();
  document.querySelector(".story-window").innerHTML = '<p><img src="images/serenaangry.gif"> <br>She thinks you are a pervert and call the police, and you are arrested......';
